...
"""
  ...
  environment {
    ...
    GITHUB_GROUP = "brown-redcloud3"
    GITHUB_PROJECT = "spring-petclinic"
    GITHUB_PROJECT_URL = "https://github.com/brown-redcloud3/spring-petclinic"
    ...
    MATTERMOST_WEBHOOK = "https://mattermost.mgt.brown.perspectatechdemos.com/hooks/o9dtxzyyhjf7fgnb1uwg6hnhiw"
